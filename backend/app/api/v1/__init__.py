...
api_router.include_router(child_checkin.router, prefix="/child-checkin", tags=["child_checkin"])
api_router.include_router(child_checkin.public_router, prefix="/child-checkin", tags=["child_checkin_public"])
