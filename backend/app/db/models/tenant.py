...
class Tenant(Base):
    ...
    landing_hero_background_url: Mapped[str | None] = mapped_column(String(500), nullable=True)
    landing_pix_key: Mapped[str | None] = mapped_column(String(255), nullable=True)
    landing_bank_name: Mapped[str | None] = mapped_column(String(255), nullable=True)
    landing_bank_agency: Mapped[str | None] = mapped_column(String(120), nullable=True)
    landing_bank_account: Mapped[str | None] = mapped_column(String(120), nullable=True)
    landing_service_times: Mapped[str | None] = mapped_column(String(2000), nullable=True)
    landing_address: Mapped[str | None] = mapped_column(String(500), nullable=True)
    landing_location_url: Mapped[str | None] = mapped_column(String(1000), nullable=True)
    landing_footer_text: Mapped[str | None] = mapped_column(String(500), nullable=True)
