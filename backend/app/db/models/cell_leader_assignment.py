...
class CellLeaderAssignment(Base):
    __tablename__ = "cell_leader_assignments"
    ...
    discipler_member_id: Mapped[int | None] = mapped_column(
        Integer,
        ForeignKey("cell_members.id", ondelete="SET NULL"),
        nullable=True,
        index=True,
    )
    role: Mapped[str] = mapped_column(String(20), nullable=False, default="co_leader")
